...
//        AuthService authService = new AuthServiceImpl();
        context.addServlet(new ServletHolder(new WebSocketGameServlet(accountService, gameMechanics, webSocketService)), "/game");

        context.addServlet(new ServletHolder(new GameServlet(gameMechanics, accountService)), "/gameplay");
